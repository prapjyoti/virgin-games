...
@RunWith(Cucumber.class)//Running with cucumber class
//Plugin required for reports,json for reports in jenkins.
@CucumberOptions(
        features = ".",
...
//test are run from this class
public class CukeTest {

    //code for running extent-report after class
