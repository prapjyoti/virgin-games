...
public class Utility extends BasePage {
    ...
    // Utility extends with the BasePage Class to inherit the properties of BasePage in test
    // utility class stores and the handle the functions like waits,random method,actions exc....
    //which can be used across the entire framework
    // utility class to achieve re usability.
   ...
   // This method is used for when type is submit and user for click on login button
    public void clickOnSubmit(By by) {
